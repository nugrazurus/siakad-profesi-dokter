    ...
    <div class="row h-100">
        ...
        <div class="col-md-6 d-flex align-items-center justify-content-center">
            <div class="d-flex flex-column w-75">
                ...
                <p class="text-black-50">Silahkan masukkan username (NIM), password di form berikut dengan benar </p>
                <form action="{{ route('post.login-mahasiswa') }}" method="POST" enctype="application/x-www-form-urlencoded">
                    @csrf
